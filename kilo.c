...
char *C_HL_keywords[] = {
        ...
        "enum", "class", "case", "int|", "long|", "double|", "float|", "char|", "unsigned", "signed|", "void|", NULL
};
...
void editorFind() {
    ...
    char *query = editorPrompt("Search: %s (Use ECS/Arrows/Enter)", editorFindCallback);
